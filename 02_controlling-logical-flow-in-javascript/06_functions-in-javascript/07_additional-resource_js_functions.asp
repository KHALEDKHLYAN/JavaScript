...
<a class="w3-left w3-btn" href="js_datatypes.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="js_objects.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryjs_functions" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>JavaScript Function Syntax</h2>
<p>A JavaScript function is defined with the <code class="w3-codespan">function</code> keyword, 
...
<p>When JavaScript reaches a <code class="w3-codespan">return</code> statement, 
...
<div class="w3-code notranslate jsHigh">
let x = myFunction(4, 3);&nbsp;&nbsp;&nbsp;// Function is called, return value will end up in x<br><br>
...
<a target="_blank" href="tryit.asp?filename=tryjs_function_return" class="w3-btn w3-margin-bottom w3-margin-top">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryjs_farenheit_to_celsius" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>The () Operator Invokes the Function</h2>
<p>Using the example above, <code class="w3-codespan">toCelsius</code> refers to the function object, and 
<code class="w3-codespan">toCelsius()</code> refers to the function result.</p>
<p>Accessing a function without () will return the function object instead of 
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_farenheit_to_celsius_2" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_variable" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_scope" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise_js.asp?filename=exercise_js_functions1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>Execute the function named <code class="w3-codespan">myFunction</code>.</p>
...
<p><a target="_blank" href="exercise_js.asp?filename=exercise_js_functions1">Start the Exercise</a></p>
</div>
</form>
