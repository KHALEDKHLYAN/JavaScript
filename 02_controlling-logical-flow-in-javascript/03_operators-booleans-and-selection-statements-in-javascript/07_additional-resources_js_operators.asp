...
<a target="_blank" href="tryit.asp?filename=tryjs_oper" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>The <strong>assignment</strong> operator (<code class="w3-codespan">=</code>) assigns a value to a variable.</p>
<div class="w3-example">
<h3>Assignment</h3>
<div class="w3-code notranslate jsHigh">
let x = 10;</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_oper_equal" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>The <strong>addition</strong> operator (<code class="w3-codespan">+</code>) adds numbers:</p>
<div class="w3-example">
<h3>Adding</h3>
<div class="w3-code notranslate jsHigh">
let x = 5;<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_oper_add" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>The <strong>multiplication</strong> operator (<code class="w3-codespan">*</code>) multiplies numbers.</p>
<div class="w3-example">
<h3>Multiplying</h3>
<div class="w3-code notranslate jsHigh">
let x = 5;<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_oper_mult" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<h3>Assignment</h3>
 <div class="w3-code notranslate jsHigh">
let x = 10;<br>x += 5;</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_oper_plusequal" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">+</code> operator can also be used to add (concatenate) strings.</p>
...
<a class="w3-btn w3-margin-bottom w3-margin-top" href="tryit.asp?filename=tryjs_oper_concatenate" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom w3-margin-top" href="tryit.asp?filename=tryjs_oper_concat4" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel w3-note">
...
<a class="w3-btn w3-margin-bottom w3-margin-top" href="tryit.asp?filename=tryjs_oper_concat5" target="_blank">Try it Yourself &raquo;</a>
</div>
